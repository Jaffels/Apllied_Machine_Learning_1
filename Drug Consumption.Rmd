...
Cannabis use remains one of the most widespread forms of recreational drug consumption—and while it’s legal in more places than ever, it still carries important health and social implications. In this project, we zero in on what drives people to try or regularly use cannabis, drawing on the same rich survey of 1,885 individuals that captures demographics, three personality inventories (NEO-FFI-R, BIS-11, ImpSS), and self-reported patterns of use.

By recoding cannabis consumption into seven ordered categories—from “Never Used” through “Used in Last Day”—we can treat it as an ordinal outcome and ask which factors tip someone toward experimentation, occasional use, or daily habit. Our predictors include age, gender, education level, country, and ethnicity alongside continuous personality scores for neuroticism, extraversion, openness, agreeableness, conscientiousness, impulsivity, and sensation-seeking.

Through exploratory data analysis and machine-learning models, we’ll trace how cannabis use prevalence shifts across life stages and educational backgrounds, and how individual differences in discipline, thrill-seeking, or social engagement relate to someone’s likelihood of using. Focusing on cannabis lets us illustrate how demographic and psychological dimensions interplay to shape real-world behavior—ultimately guiding more nuanced conversations about public health, policy, and personalized risk factors.
...
As a first step, a three-layer feedforward neural network was trained using an 80/20 stratified split, ensuring balanced class representation while managing model complexity and reducing the risk of overfitting. The training dataset was restricted to individuals who reported drug use within the last year to ensure relevance. The ANN was optimized using a classification loss function with a strict convergence threshold and a sufficient number of training steps.
