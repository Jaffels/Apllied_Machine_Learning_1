...
```{r age-use curve, echo=FALSE, cache=TRUE, fig.width=10, fig.height=10}
...
# 4) Extract and tidy the parametric coefficients table
...
# 5) Print the parametric coefficients table with kable()
kable(
  param_df,
...
# 6) Extract and tidy the smooth‐terms table
...
# 7) Print the smooth‐term statistics table with kable()
