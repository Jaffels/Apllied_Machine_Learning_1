...
```{r age-use curve, echo=FALSE, cache=TRUE, fig.width=5, fig.height=4}
...
```{r glmbi_model5, echo=FALSE, cache=TRUE}
# Fit the model 
...
```{r gam_eda_plot_age_edu3, echo=FALSE, cache=TRUE,fig.width=12, fig.height=10, dpi=125}
education_levels <- c(
  "Not Provided",
